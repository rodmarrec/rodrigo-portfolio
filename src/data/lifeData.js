// ─── Color Palette ───────────────────────────────────────────────
export const COLORS = {
  childhood:    '#60a5fa',  // bright blue
  school:       '#93c5fd',  // lighter blue
  uh:           '#ef4444',  // bright red
  architecture: '#4ade80',  // bright green
  wework:       '#2dd4bf',  // teal
  netflix:      '#a78bfa',  // purple
  peopleinc:    '#c084fc',  // lighter purple
  apple:        '#94a3b8',  // slate
  unemployment: '#facc15',  // bright yellow
  ga:           '#fb923c',  // orange
  covid:        '#f472b6',  // pink
  milestone:    '#22d3ee',  // cyan
  empty:        'rgba(255,255,255,0.04)',
}

// City left-bar gradient — warm amber/orange, reversed light-to-dark top-to-bottom
export const CITY_COLORS = {
  mexicoCity:   '#fed7aa',  // lightest
  sugarLand1:   '#fdba74',
  houston:      '#fb923c',
  sugarLand2:   '#f97316',
  sanFrancisco: '#ea580c',
  sfSunnyvale:  '#c2410c',  // darkest
}

export const events = [
  // ── Milestones ──
  { id: 'birth',    label: 'Born in CDMX',           emoji: '🌎', start: { year: 1989, month: 6  }, end: { year: 1989, month: 6  }, color: COLORS.milestone, type: 'milestone' },
  { id: 'moveSL',   label: 'Moved to Sugar Land, TX', emoji: '📦', start: { year: 1991, month: 5  }, end: { year: 1991, month: 5  }, color: COLORS.milestone, type: 'milestone' },
  ...
  { id: 'es',       label: 'Elementary',       start: { year: 1995, month: 8  }, end: { year: 2000, month: 5  }, color: COLORS.school,       type: 'era' },
  { id: 'sum95',    label: '',                 start: { year: 1995, month: 6  }, end: { year: 1995, month: 7  }, color: COLORS.childhood,    type: 'era' },
  { id: 'sum00',    label: '',                 start: { year: 2000, month: 6  }, end: { year: 2000, month: 7  }, color: COLORS.childhood,    type: 'era' },
  { id: 'ms1',      label: 'MS 1',             start: { year: 2000, month: 8  }, end: { year: 2001, month: 5  }, color: COLORS.school,       type: 'era' },
  { id: 'sum01',    label: '',                 start: { year: 2001, month: 6  }, end: { year: 2001, month: 7  }, color: COLORS.childhood,    type: 'era' },
  { id: 'ms2',      label: 'MS 2',             start: { year: 2001, month: 8  }, end: { year: 2004, month: 5  }, color: COLORS.school,       type: 'era' },
  { id: 'sum04',    label: '',                 start: { year: 2004, month: 6  }, end: { year: 2004, month: 7  }, color: COLORS.childhood,    type: 'era' },
  { id: 'hs1',      label: 'HS 1',             start: { year: 2004, month: 8  }, end: { year: 2006, month: 5  }, color: COLORS.school,       type: 'era' },
  { id: 'sum06',    label: '',                 start: { year: 2006, month: 6  }, end: { year: 2006, month: 7  }, color: COLORS.childhood,    type: 'era' },
  { id: 'hs2',      label: 'HS 2',             start: { year: 2006, month: 8  }, end: { year: 2008, month: 5  }, color: COLORS.school,       type: 'era' },
  { id: 'sum08',    label: '',                 start: { year: 2008, month: 6  }, end: { year: 2008, month: 7  }, color: COLORS.childhood,    type: 'era' },
  { id: 'uh',       label: 'UH · BARCH',       start: { year: 2008, month: 8  }, end: { year: 2014, month: 5  }, color: COLORS.uh,           type: 'era' },
  { id: 'pbdesign', label: 'Patrick Berrios',  start: { year: 2014, month: 7  }, end: { year: 2015, month: 7  }, color: COLORS.architecture, type: 'era' },
  { id: 'unemp1',   label: '1st Unemployed',   start: { year: 2015, month: 7  }, end: { year: 2016, month: 5  }, color: COLORS.unemployment, type: 'era' },
  ...
  { id: 'unemp2',   label: '2nd Unemployed',   start: { year: 2020, month: 6  }, end: { year: 2021, month: 1  }, color: COLORS.unemployment, type: 'era' },
